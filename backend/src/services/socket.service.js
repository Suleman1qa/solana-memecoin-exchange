...
exports.notifyWalletUpdate = (userId, walletId) => {
  if (!io) return;
...
exports.notifyTransactionUpdate = (userId, transactionId) => {
  if (!io) return;
...
exports.notifyOrderUpdate = (pairId, order) => {
  if (!io) return;
...
exports.notifyTradeUpdate = (pairId, trade) => {
  if (!io) return;
...
exports.broadcastMarketUpdates = async () => {
  if (!io) return;
